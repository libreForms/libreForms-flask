...
In addition, the default site config options can be overridden by adding a file called `.py` to the `app/` directory. This file should contain a dictionary object with key-value attributes that you want to override. 
